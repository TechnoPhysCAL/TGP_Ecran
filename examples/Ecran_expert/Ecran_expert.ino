...
Ecran monEcran(OLED_RESET,DEFAULT_ADDRESS); // Création de l'objet 'ecran' de classe Ecran.
...
void setup()
{
    ...
    {
        Serial.println("Echec d'initialisation de l'écran.") while (true) {} // on ne continue pas le code
    }
    next_event = 0;
}
